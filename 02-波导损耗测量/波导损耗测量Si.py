...
layout.move_name('3_SiN',0, Y_shift)

L_add = 200
draw_base(4)
Y_shift = Y_shift -2*R_ring-L_add - 100
layout.move_name('4_SiN',0, Y_shift)

L_add = 400
draw_base(5)
Y_shift = Y_shift -2*R_ring-L_add- 100
layout.move_name('5_SiN',0, Y_shift)

L_add = 800
draw_base(6)
Y_shift = Y_shift -2*R_ring-L_add- 100
layout.move_name('6_SiN',0, Y_shift)

L_add = 1600
draw_base(7)
Y_shift = Y_shift -2*R_ring-L_add- 100
layout.move_name('7_SiN',0, Y_shift)
